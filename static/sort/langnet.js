...
function drawNetwork() {
	...
	anchorNode.filter(function(d, i) {
		return i % 2 != 0; })
		.append("image")
		.attr("id",function(d, i) { console.log(d.node.label); return "t_"+d.node.label })
		.attr("xlink:href", function(d) { return d.node.label; })
		.attr("width", function(d) { return d.node.size;})
		.attr("height", function(d){ return d.node.size; });
